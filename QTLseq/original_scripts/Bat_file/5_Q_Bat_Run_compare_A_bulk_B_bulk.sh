...
Rscript ../script/8_MutMap_graph_bulkA.R s_m_P1_A_bulk_B_bulk.pileup sliding_window_${window_size_Mb}_Mb_s_m_P1_A_bulk_B_bulk.pileup A_bulk B_bulk
Rscript ../script/8_MutMap_graph_bulkB.R s_m_P1_A_bulk_B_bulk.pileup sliding_window_${window_size_Mb}_Mb_s_m_P1_A_bulk_B_bulk.pileup A_bulk B_bulk
Rscript ../script/8_MutMap_graph_bulkD.R s_m_P1_A_bulk_B_bulk.pileup sliding_window_${window_size_Mb}_Mb_s_m_P1_A_bulk_B_bulk.pileup A_bulk B_bulk
